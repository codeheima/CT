...
function calendar(control,flag,timeshow){
	var id = control.id;
	if(timeshow=="1")
		WdatePicker({el:id,skin:'whyGreen',dateFmt:'yyyy-MM-dd'});
	if(timeshow=="2")
		WdatePicker({el:id,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH'});
	if(timeshow=="3")
		WdatePicker({el:id,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm'});
	if(timeshow=="4")
		WdatePicker({el:id,skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'});					
}